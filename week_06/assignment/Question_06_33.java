...
public class Question_06_33 {
    ...
    public static int getCurrentSeconds(long milliSeconds) {//2.
        return getTotalSeconds(milliSeconds) % 60;
    }

    public static int getTotalSeconds(long milliseconds) {    //1.
        return (int) (milliseconds / 1000);
    }

    public static int getCurrentMinute(long milliseconds) {//4.
        return getTotalMinutes(milliseconds) % 60;
    }

    public static int getTotalMinutes(long milliseconds) {//3.
        return getTotalSeconds(milliseconds) / 60;
    }

    public static int getCurrentHour(long milliseconds) {//6.
        return getTotalHour(milliseconds) % 24;
    }

    public static int getTotalHour(long milliseconds) {//5.
        return getTotalMinutes(milliseconds) / 60;
    }
